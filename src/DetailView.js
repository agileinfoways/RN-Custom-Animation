...
const images = [
  require('../android/app/src/main/res/drawable/download1.jpeg'),
  require('../android/app/src/main/res/drawable/download2.jpeg'),
  require('../android/app/src/main/res/drawable/download3.jpeg'),
...
export default class DetailView extends Component {
  ...
  animValUpTiming = Animated.spring(this.animZoomVal, {
    toValue: 1,
    duraton: 3000,
    easing: Easing.inOut(Easing.quad),
    stiffness:200
  })
  animValDownTiming = Animated.spring(this.animZoomVal, {
    toValue: 0,
    duraton: 3000,
    easing: Easing.inOut(Easing.quad),
    stiffness:200
        ...
        </Animated.View>
        {
          ...
          (
            ...
            >
              ...
              >
                <Image
                  source={require("../android/app/src/main/res/drawable-hdpi/back_arrow.png")}
                />
              </TouchableOpacity>
            </Animated.View>
          )
